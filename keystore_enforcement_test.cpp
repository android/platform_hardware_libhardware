...
TEST_F(RescopeBaseTest, TEST_INVALID_RESCOPE_ADD_DEL) {
    ...
    ASSERT_EQ(KM_ERROR_INVALID_RESCOPING, kse.AuthorizeRescope(1, &auth_set1, &auth_set5, 1));
}
...
TEST_F(KeystoreBaseTest, TEST_INVALID_TAG_PAIRS) {
    ...
    ASSERT_EQ(KM_ERROR_INVALID_TAG,
              kse.AuthorizeOperation(KM_PURPOSE_VERIFY, key_id, &auth_set1, uid, def_app_id));
    ASSERT_EQ(KM_ERROR_INVALID_TAG,
              kse.AuthorizeOperation(KM_PURPOSE_VERIFY, key_id, &auth_set2, uid, def_app_id));
    ASSERT_EQ(KM_ERROR_INVALID_TAG,
              kse.AuthorizeOperation(KM_PURPOSE_VERIFY, key_id, &auth_set3, uid, def_app_id));
}
