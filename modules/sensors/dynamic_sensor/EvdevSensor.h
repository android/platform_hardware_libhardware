...
private:
    ...
    // sensor related information parsed from Evdev descriptor
    struct FeatureValue {
        ...
        // if the device is custom sensor Evdev device that furnished android specific descriptors
