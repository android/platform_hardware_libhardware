...
#ifndef ANDROID_INCLUDE_BT_BLE_ADVERTISER_H
#define ANDROID_INCLUDE_BT_BLE_ADVERTISER_H
...
} bt_le_advertiser_callbacks_t;

typedef struct {
    /** Registers a advertiser with the stack */
...
} bt_le_advertiser_interface_t;

__END_DECLS

#endif /* ANDROID_INCLUDE_BT_BLE_ADVERTISER_H */
