...
class BleAdvertiserInterface {
 public:
  ...
  virtual void SetPeriodicAdvertisingData(uint8_t advertiser_id, uint8_t operation,
                        uint8_t periodic_data_length, std::vector<uint8_t> periodic_data,
                         Callback cb) = 0;
  ...
  virtual void EnablePeriodicAdvertisement(uint8_t enable, uint8_t handle,
                         Callback cb) = 0;
