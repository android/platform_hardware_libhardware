...
typedef enum {
    ...
    KM_TAG_MIN_MAC_LENGTH = KM_UINT | 8, /* Minimum length of MAC or AEAD authentication tag in
                                          * bits. */
    KM_TAG_KDF = KM_ENUM_REP | 9,        /* keymaster_kdf_t (keymaster2 only) */
    KM_TAG_EC_CURVE = KM_ENUM | 10,      /* keymaster_ec_curve_t ( keymaster2 only) */
    ...
    KM_TAG_INCLUDE_UNIQUE_ID = KM_BOOL | 1004, /* If true attestation certificate will contain an
                                                * application-scoped and time-bounded device-unique
                                                * ID. (keymaster2) */
} keymaster_tag_t;
...
typedef enum {
    ...
    KM_KDF_ISO18033_1_KDF2_SHA1 = 2,
    /* KDF1 defined in ISO 18033-2 with SHA256 */
    KM_KDF_ISO18033_1_KDF1_SHA256 = 3,
...
typedef enum {
    ...
    KM_ERROR_INVALID_GENERATION_REQUEST = -63,
