...
typedef enum {
    ...
    KM_TAG_ECIES_SINGLE_HASH_MODE = KM_BOOL | 204, /* Whether the ephemeral public key is fed into the KDF,
                                                      see http://www.shoup.net/iso/std6.pdf, clause 10.2 */
...
typedef enum {
    ...
    KM_KDF_ISO18033_1_KDF2_SHA256 = 2,
    /* KDF2 defined in ISO 18033-2 with SHA1 */
    KM_KDF_ISO18033_2_KDF2_SHA256 = 3,
