...
typedef enum {
    ...
    KM_TAG_ALLOW_CHUNKLESS = KM_BOOL | 8, /* Allow arbitrary-length AEAD mode encryptions.  WARNING:
                                             Not recommended.  Returns unauthenticated plaintext. */
    ...
    KM_TAG_CHUNK_LENGTH = KM_INT | 1002,      /* AEAD mode chunk size, in bytes. */
} keymaster_tag_t;
