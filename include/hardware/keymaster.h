...
typedef enum {
    ...
    KM_TAG_USER_ID = KM_INT | 500, /* ID of authorized user. Set to KM_ALL_USERS_AUTHORIZED to
                                      allow all users. */
    KM_TAG_USER_AUTH_ID = KM_INT_REP | 501,     /* ID of the authenticator to use (e.g. password,
                                                   fingerprint, etc.).  Repeatable to support
                                                   multi-factor auth.  If no user authentication is
                                                   desired, set to KM_NO_AUTHENTICATION_REQUIRED. */
