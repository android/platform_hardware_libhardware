...
struct keymaster1_device {
    ...
    /**
     * See flags defined for keymaster0_device::flags above.
     */
    uint32_t flags;
     ...
     */
    int (*generate_keypair)(const struct keymaster1_device* dev,
     ...
     * Returns: 0 on success or an error code less than 0.
     */
    int (*import_keypair)(const struct keymaster1_device* dev,
     ...
     */
    int (*get_keypair_public)(const struct keymaster1_device* dev,
     ...
     * Returns 0 on success or an error code less than 0.
     */
    int (*delete_keypair)(const struct keymaster1_device* dev,
            const uint8_t* key_blob, const size_t key_blob_length);
     ...
     * Returns: 0 on success or an error code less than 0.
     */
    int (*sign_data)(const struct keymaster1_device* dev,
     ...
     */
    int (*verify_data)(const struct keymaster1_device* dev,
            const void* signing_params,
            const uint8_t* key_blob, const size_t key_blob_length,
