...
keymaster_error_t KeystoreEnforcement::AuthorizeOperation(const keymaster_purpose_t purpose,
                                                          const km_id_t keyid,
...
keymaster_error_t KeystoreEnforcement::AuthorizeParameter(
    const AuthorizationSet* auth_set, const km_id_t keyid, const keymaster_key_param_t param,
    const keymaster_purpose_t purpose, const uid_t uid, const keymaster_blob_t appid) {
...
keymaster_error_t
KeystoreEnforcement::authorize_usage_expire_time(const keymaster_key_param_t param,
                                                 const time_t current_time,
...
keymaster_error_t
KeystoreEnforcement::authorize_origination_expire_time(const keymaster_key_param_t param,
                                                       const time_t current_time,
                                                       const keymaster_purpose_t purpose) {
...
keymaster_error_t KeystoreEnforcement::authorize_min_time_between_ops(
...
keymaster_error_t
KeystoreEnforcement::authorize_single_use_per_boot(const keymaster_key_param_t param,
                                                   const km_id_t keyid) {
...
bool KeystoreEnforcement::valid_rescope_del(const AuthorizationSet* auth_set,
...
bool KeystoreEnforcement::valid_rescope_add(const AuthorizationSet* auth_set,
                                            const keymaster_tag_t tag) {
...
uint32_t KeystoreEnforcement::key_id_to_index(const km_id_t keyid) { return keyid; }
...
time_t KeystoreEnforcement::get_current_time() { return time(NULL); }
...
time_t KeystoreEnforcement::get_last_auth_time() { return last_auth_time; }
...
bool KeystoreEnforcement::supported_purpose(const keymaster_purpose_t purpose) {
    switch (purpose) {
...
bool KeystoreEnforcement::supported_purposes(const AuthorizationSet* auth_set) {
    int purpose_index;
...
keymaster_error_t KeystoreEnforcement::valid_purpose(const keymaster_purpose_t purpose,
                                                     const AuthorizationSet* auth_set) {
