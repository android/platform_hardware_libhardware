...
CPPSRCS=authorization_set.cpp \
	...
	keystore_enforcement.cpp \
	keystore_enforcement_test.cpp
...
BINARIES=authorization_set_test keystore_enforcement_test
...
keystore_enforcement_test: keystore_enforcement_test.o \
	keystore_enforcement.o \
  	authorization_set.o \
	$(BASE)/external/gtest/src/gtest-all.o
